        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= (validation_show_error('username')) ? 'is-invalid' : '' ?>" id="username" name="username" value="<?= old('username') ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= (validation_show_error('role_id')) ? 'is-invalid' : '' ?>" id="role_id" name="role_id" required>
                                ...
                                <?php foreach ($roles as $role): ?>
                                    <option value="<?= $role['id'] ?>" <?= set_select('role_id', $role['id']) ?>><?= esc($role['role_name']) ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="form-check form-switch mt-3">
                    ...
                    <label class="form-check-label" for="active">Jadikan Pengguna Aktif</label>
                </div>
