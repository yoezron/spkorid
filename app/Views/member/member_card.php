    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body text-center">
                <p class="card-description">Ini adalah kartu anggota digital Anda. Anda dapat mengunduhnya sebagai gambar PNG.</p>

                <div id="member-card-container" class="mt-4 mb-4">
                    <img src="<?= base_url('member/card/generate-qr') ?>" alt="Kartu Angota" class="img-fluid rounded" style="max-width: 400px; border: 1px solid #eee;">
                </div>

                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="<?= base_url('member/card/download') ?>" class="btn btn-primary">
                        <i class="material-icons-outlined">download</i> Unduh Kartu
                    </a>
